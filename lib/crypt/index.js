...
export const encrypt = async (sourceFilePath, password, progressCallback, errorCallback) => {
...
export const decrypt = async (sourceFilePath, password, progressCallback, errorCallback) => {
